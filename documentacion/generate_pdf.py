...
content.append(Paragraph("Enterprise-Grade Algorithmic Trading Platform with ML Intelligence", 
...
content.append(Paragraph(
    ...
    ParagraphStyle('code', parent=styles['Normal'], fontSize=8, 
                  ...
                  leftIndent=20, spaceAfter=12, backColor=colors.HexColor('#F5F5F5'))
))
...
structure_items = [
    ...
    ("<b>src/trading_phantom/modules/</b>", "Strategy, RiskManager, Trader, DataLoader"),
    ("<b>src/trading_phantom/analytics/</b>", "ML Pipeline, Knowledge Base, Transfer Learning"),
    ("<b>src/trading_phantom/api/</b>", "REST API Blueprints (bot, backtest, analytics)"),
...
ml_components = [
    ...
    ("<b>7 Features:</b>", "EMA, MACD, RSI, cambio precio, volumen, volatilidad, tendencia"),
...
kb_data = [
    ...
    ["5", "Performance Metrics", "performance_metrics.json", "Accuracy, precision, recall"],
...
content.append(Paragraph(
    "<b>Ubicación:</b> src/trading_phantom/data/knowledge_base/",
    body_style
))
...
content.append(Paragraph(
    "<b>Licencia:</b> MIT (libre para usar, modificar y distribuir)",
    body_style
))

content.append(Spacer(1, 0.1*inch))
content.append(Paragraph(
    "<b>GitHub:</b> https://github.com/blaspinto5/trading_phantom",
    body_style
))
...
content.append(Paragraph(
    ...
    ParagraphStyle('line', parent=styles['Normal'], fontSize=8, 
